...
import com.bodedimitri.course.entities.Payment;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired //Depois de criada a entidade e criada uma interface extendendo JPA e usando como parametro a nossa entidade para depois ela ser instanciada
	...
	public void run(String... args) throws Exception { //Tudo colocado dentro desse metodo vai ser executado quando a aplicação for iniciada
		...
		o1.setPayment(pay1); //Associar order com payment
